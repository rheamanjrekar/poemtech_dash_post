...
DashReadEvalPrint.run(Mirror);

//This is a power on self test that flashes the RGB LED red, green, blue, 
//and white, and then flashes the white built in LED.//Run the interpreter using USB Serial
HologramCloud.setRGB("RED");         //set RGB red
delay(1000);                        //wait one second
HologramCloud.setRGB("GREEN");      //set RGB green
delay(1000);                        //wait one second
HologramCloud.setRGB("BLUE");       //set RGB blue
delay(1000);                       //wait one second
HologramCloud.setRGB("WHITE");     //set RGB white
delay(1000);                       //wait one second
